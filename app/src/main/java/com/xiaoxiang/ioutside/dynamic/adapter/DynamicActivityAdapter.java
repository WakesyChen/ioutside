 ...
 */
public class DynamicActivityAdapter extends RecyclerView.Adapter<DynamicActivityAdapter.DynamicTypeViewHolder> {
    ...
    public DynamicTypeViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.dynamic_activity_item,parent,false);
    ...
    public void onBindViewHolder(final DynamicTypeViewHolder holder, final int position) {
        holder.dynamic_activity_textView.setText(list.get(position).getTypeName());
    }
    ...
    public class DynamicTypeViewHolder extends RecyclerView.ViewHolder{
        ...
        public DynamicTypeViewHolder(View view){
            super(view);
            dynamic_activity_textView=(TextView)view.findViewById(R.id.dynamic_activity_textView);
