...
public class RecyclerViewHolder extends RecyclerView.ViewHolder{
    ...
    public RecyclerViewHolder setBtnText(int viewId,String text){
        mHolderImpl.setBtnText(viewId,text);
        return this;
    }

    public RecyclerViewHolder setBtnTextSize(int viewId,float size){
        mHolderImpl.setBtnTextSize(viewId,size);
        return this;
    }
    ...
    * 图片显示
    * */
    public RecyclerViewHolder setDrawableLoader(int viewId,String url,ImageLoader imageLoader){
        mHolderImpl.setDrawableLoader(viewId,url,imageLoader);
        return this;
    }
    ...
    public RecyclerViewHolder setBackgroundRes(int viewId,int drawableId){
        mHolderImpl.setBackgroudRes(viewId,drawableId);
        return this;
    }
