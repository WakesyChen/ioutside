...
public class ViewHolderImpl {
    //这是一个类似hashmap的东西，但是在这种情况下效率更高
    private SparseArray<View> mCacheViews=new SparseArray<>();

    //item view
    View mItemView;

    public ViewHolderImpl(View mItemView) {
    ...
    * */
    ...
    public void setBtnTextSize(int viewId,float size){
    ...
    public void setBackgroudRes(int viewId,int drawableId){
        View target=findViewById(viewId);
    ...
    public void setDrawableLoader(int viewId,String url,ImageLoader imageLoader){
